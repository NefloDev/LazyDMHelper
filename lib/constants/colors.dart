...
class CustomColors{
  ...
  static const Color gray = Color(0xFFC2C2C3);
  static const Color darkGray = Color(0xFF858181);
  static const Color highlight = Color(0xFF0094FF);
  static const Color contrast = Color(0xFF64BAF9);

  //Light theme colors
  static const Color bgLight = Color(0xFFFFF8F7);
  static const Color onBgLight = Color(0xFF231919);
  static const Color primaryLight = Color(0xFF904A47);
  static const Color onPrimaryLight = Colors.white;
  static const Color primaryContainerLight = Color(0xFFFFDAD7);
  ...
  //Dark theme colors
  static const Color bgDark = Color(0xFF1A1111);
  static const Color onBgDark = Color(0xFFF1DEDD);
  static const Color primaryDark = Color(0xFFFFB3AE);
  static const Color onPrimaryDark = Color(0xFF571D1C);
  static const Color primaryContainerDark = Color(0xFF733331);
