      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DataCreationTextForm(controller: traitsController, labelText: Texts.traits, hintText: Texts.divideElements),
            DataCreationTextForm(controller: startingProficienciesController, labelText: Texts.startingProficiencies, hintText: Texts.divideElements),
            DataCreationTextForm(controller: startingProficiencyOptionsController, labelText: Texts.startingProficiencyOptions, hintText: Texts.divideElements),
            DataCreationTextForm(controller: subRacesController, labelText: Texts.subRaces, hintText: Texts.divideElements),
            const Padding(
